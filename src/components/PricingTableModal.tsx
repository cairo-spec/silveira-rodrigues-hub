...
const pricingData = [
  {
    ...
    items: [
      { service: "Assinatura Mensal", description: "Jornal de Oportunidades 2x por semana e Relatórios de Risco (RGR) ilimitados.", priceRegular: "R$ 1.500,00 /mês", priceSubscriber: "R$ 997,00 /mês", successFee: "N/A" },
      { service: "Consulta", description: "Solução de dúvidas e perguntas.", priceRegular: "R$ 516,47", priceSubscriber: "R$ 0,00 (Incluso até 4/mês)", successFee: "N/A" },
