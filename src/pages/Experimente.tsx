...
const Experimente = () => {
  ...
  useEffect(() => {
    const handleUserSession = async () => {
      ...
      // Store profile for UI decisions
      setUserProfile({
        trial_active: profile.trial_active,
        access_authorized: profile.access_authorized,
  ...
  const hasActiveAccess = userProfile?.subscription_active || 
    (userProfile?.trial_active && userProfile?.access_authorized);
              ...
              <Card className="border-2 border-primary/20 shadow-2xl shadow-primary/10 backdrop-blur">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-2xl">
                    {user ? (hasActiveAccess ? "Você já tem acesso!" : "Ativar teste grátis") : "Comece seu teste grátis"}
                  </CardTitle>
                  <CardDescription className="text-base">
                    {user 
                      ? (hasActiveAccess 
                          ? "Seu acesso já está ativo. Acesse a área de membros." 
                          : "Clique no botão abaixo para ativar seus 30 dias grátis")
                ...
                <CardContent>
                  {user ? (
                    // Logged in user - show activate trial button or go to members
                    <div className="space-y-4">
                      {hasActiveAccess ? (
                        <>
                          <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-xl text-center">
                            ...
                            <p className="font-medium text-green-700 dark:text-green-400">
                              {userProfile?.subscription_active ? "Assinatura ativa" : "Período de teste ativo"}
                            </p>
                          </div>
                          <Button 
                            size="lg"
                        ...
                        <>
                          <div className="p-4 bg-primary/10 border border-primary/20 rounded-xl text-center">
                            ...
                            <p className="font-medium text-foreground">
                              30 dias grátis esperando por você!
                            </p>
      ...
      <div className="container mx-auto px-4 py-8 text-center">
        {user ? (
          <p className="text-sm text-muted-foreground">
            <a href="/membros" className="text-primary hover:underline font-medium">
