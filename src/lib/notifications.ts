 ...
 * @param excludeUserId - Optional user ID to exclude from notifications (the actor)
 */
export const notifyAdmins = async (
  type: 'ticket_message' | 'ticket_status' | 'chat_message' | 'new_ticket' | 'message_deleted' | 'new_account',
  title: string,
  message: string,
  referenceId?: string,
