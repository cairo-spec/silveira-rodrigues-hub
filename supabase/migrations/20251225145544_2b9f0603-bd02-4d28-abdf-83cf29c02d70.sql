-- Update notify_admins function to include 'message_deleted' as an allowed notification type
...
DECLARE
  admin_user_id UUID;
  allowed_types TEXT[] := ARRAY['ticket_status', 'ticket_message', 'chat_message', 'new_account', 'opportunity_update', 'new_ticket', 'message_deleted'];
BEGIN
