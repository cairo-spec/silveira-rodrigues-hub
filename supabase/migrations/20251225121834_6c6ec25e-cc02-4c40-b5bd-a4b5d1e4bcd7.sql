-- Update notify_admins function to validate notification types
...
DECLARE
  admin_user_id UUID;
  allowed_types TEXT[] := ARRAY['ticket_status', 'ticket_message', 'chat_message', 'new_account', 'opportunity_update'];
BEGIN
...
-- Also update the overloaded version without _exclude_user_id
